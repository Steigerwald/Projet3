        ...
        switch (mode) {
            case 1:
                ...
                while (continuer) {
                    ...
                    turn = turn + 1;
                    continuer = resultJoueur.afficherResultat(tableau1, tableau2, resultat, turn, tmax, nber);
                    System.out.println();
                }
                break;
            ...
            case 2:
                ...
                while (continuer) {
                    ...
                    resultat = Result.comparer(tableau1, tableau2, nber);
                    turn = turn + 1;
                    continuer = resultOrdi.afficherResultat(tableau1, tableau2, resultat, turn, tmax, nber);
            ...
            case 3:
                ...
                while (continuer1 && continuer2) {
                    ...
                    turn = turn + 1;
                    continuer2 = resultJoueur.afficherResultat(tableau1Ordi, tableau2Joueur, resultat1, turn, tmax, nber);
                    System.out.println();
                    continuer1 = resultOrdi.afficherResultat(tableau1Joueur, tableau2Ordi, resultat2, turn, tmax, nber);
                    System.out.println();
